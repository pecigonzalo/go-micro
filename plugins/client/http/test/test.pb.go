...
// source: go-micro.dev/plugins/client/http/v3/proto/test.proto
// DO NOT EDIT!
...
It is generated from these files:
	go-micro.dev/plugins/client/http/v3/proto/test.proto
...
func init() {
	proto.RegisterFile("go-micro.dev/plugins/client/http/v4/proto/test.proto", fileDescriptor0)
}
