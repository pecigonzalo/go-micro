...
// source: go-micro.dev/examples/v4/stream/server/proto/stream.proto

/*
Package stream is a generated protocol buffer package.

It is generated from these files:
	go-micro.dev/examples/v4/stream/server/proto/stream.proto
...
var _Streamer_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "go-micro.dev/examples/v4/stream/server/proto/stream.proto",
}

func init() {
	proto.RegisterFile("go-micro.dev/examples/v4/stream/server/proto/stream.proto", fileDescriptor0)
}
