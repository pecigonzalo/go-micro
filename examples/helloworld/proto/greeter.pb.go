...
// source: go-micro.dev/examples/v4/helloworld/proto/greeter.proto
...
func init() {
	proto.RegisterFile("go-micro.dev/examples/v4/helloworld/proto/greeter.proto", fileDescriptor_f59dc6c921369088)
}
