...
import (
	...
	"go-micro.dev/plugins/registry/kubernetes/v4/client"
	"go-micro.dev/plugins/registry/kubernetes/v4/client/api"
	"go-micro.dev/plugins/registry/kubernetes/v4/client/watch"
)
