...
// source: go-micro.dev/examples/v4/server/proto/example/example.proto

/*
Package go_micro_srv_example is a generated protocol buffer package.

It is generated from these files:
	go-micro.dev/examples/v4/server/proto/example/example.proto
...
var _Example_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "go-micro.dev/examples/v4/server/proto/example/example.proto",
}

func init() {
	proto.RegisterFile("go-micro.dev/examples/v4/server/proto/example/example.proto", fileDescriptor0)
}
